  ...
  return {
    addImports: (importObject, importsContext) => {
      ...
      bjs["swift_js_return_optional_string"] = function (isSome, ptr, len) {
        ...
        else tmpRetString = decodeString(ptr, len);
      };
      ...
      const BrowserInterop = (importObject["BrowserInterop"] =
        importObject["BrowserInterop"] || {});
      ...
      BrowserInterop["bjs_JSDocument_createElement"] =
        function bjs_JSDocument_createElement(
          self,
          tagNameBytes,
          tagNameCount,
        ) {
      ...
      BrowserInterop["bjs_JSDocument_createTextNode"] =
        function bjs_JSDocument_createTextNode(self, textBytes, textCount) {
          try {
      ...
      BrowserInterop["bjs_JSDocument_querySelector"] =
        function bjs_JSDocument_querySelector(
          self,
          selectorBytes,
          selectorCount,
        ) {
      ...
      BrowserInterop["bjs_JSDocument_addEventListener"] =
        function bjs_JSDocument_addEventListener(
          self,
          typeBytes,
          typeCount,
          listener,
          ...
          try {
            ...
            swift.memory
              .getObject(self)
              .addEventListener(string, swift.memory.getObject(listener));
          } catch (error) {
            setException(error);
          }
        };
      BrowserInterop["bjs_JSDocument_removeEventListener"] =
        function bjs_JSDocument_removeEventListener(
          self,
          typeBytes,
          typeCount,
          listener,
          ...
          try {
            ...
            swift.memory
              .getObject(self)
              .removeEventListener(string, swift.memory.getObject(listener));
          } catch (error) {
            setException(error);
          }
        };
      ...
      BrowserInterop["bjs_JSElement_setAttribute"] =
        function bjs_JSElement_setAttribute(
          self,
          nameBytes,
          nameCount,
          valueBytes,
      ...
      BrowserInterop["bjs_JSElement_removeAttribute"] =
        function bjs_JSElement_removeAttribute(self, nameBytes, nameCount) {
          try {
            const string = decodeString(nameBytes, nameCount);
      ...
      BrowserInterop["bjs_JSElement_insertBefore"] =
        function bjs_JSElement_insertBefore(self, newChild, refChild) {
          try {
            swift.memory
              .getObject(self)
              .insertBefore(
                swift.memory.getObject(newChild),
                swift.memory.getObject(refChild),
              );
          } catch (error) {
            setException(error);
          }
      ...
      BrowserInterop["bjs_JSElement_addEventListener"] =
        function bjs_JSElement_addEventListener(
          self,
          typeBytes,
          typeCount,
          listener,
      ...
      BrowserInterop["bjs_JSElement_removeEventListener"] =
        function bjs_JSElement_removeEventListener(
          self,
          typeBytes,
          typeCount,
          listener,
      ...
      BrowserInterop["bjs_JSCSSStyleDeclaration_getPropertyValue"] =
        function bjs_JSCSSStyleDeclaration_getPropertyValue(
          self,
          nameBytes,
          nameCount,
        ) {
      ...
      BrowserInterop["bjs_JSCSSStyleDeclaration_setProperty"] =
        function bjs_JSCSSStyleDeclaration_setProperty(
          self,
          nameBytes,
          nameCount,
          valueBytes,
      ...
      BrowserInterop["bjs_JSCSSStyleDeclaration_removeProperty"] =
        function bjs_JSCSSStyleDeclaration_removeProperty(
          self,
          nameBytes,
          nameCount,
        ) {
      ...
      BrowserInterop["bjs_JSAnimation_onfinish_set"] =
        function bjs_JSAnimation_onfinish_set(self, newValue) {
          try {
            swift.memory.getObject(self).onfinish =
              swift.memory.getObject(newValue);
          } catch (error) {
            setException(error);
          }
        };
